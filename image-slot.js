  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      if (url && !attrError) {
        ...
        // Inline too: a host framework re-render can strip data-filled from
        // the host, which would re-show the dashed ring over a loaded photo.
        ...
        if (!mask) this._ring.style.display = '';
      }
